...
public class NewUser extends javax.swing.JPanel {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String userName=solveSpace(jTextField1.getText());
        String Password=solveSpace(jPasswordField1.getText());
        String Fname=solveSpace(jTextField2.getText());
        String Lname=solveSpace(jTextField4.getText());
        String position=jComboBox1.getSelectedItem().toString();
       try{
            boolean chid= CHECK_USERNAME(userName);
            if (chid==false)
            {//send error to add student with id
                jLabel8.setText("The user is exist");
                jLabel8.setVisible(true);
                return;
            }
            BufferedWriter fw= new BufferedWriter(new FileWriter(Users,true));
            fw.write(userName+" "+Password+" "+Fname+" "+Lname+" "+position);
            fw.newLine();
            fw.close();
