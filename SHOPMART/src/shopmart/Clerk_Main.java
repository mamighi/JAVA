 ...
 * @author mohammad
 */
public class Clerk_Main extends javax.swing.JPanel {

    /**
     * Creates new form Clerk_Main
     */
    String userName="";
    NewSupplier ns;
    NewItem ni;
    ...
    public Clerk_Main() throws RemoteException {
        this.cr = new CheckRequest();
        this.ni = new NewItem();
        this.ns = new NewSupplier();
        cpr=new CreatePR();
        initComponents();
