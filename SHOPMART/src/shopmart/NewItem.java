 ...
 * @author mohammad
 */
public class NewItem extends javax.swing.JPanel {
    ...
    public NewItem() throws RemoteException {
        initComponents();
        refresh();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String supp=solveSpace(jComboBox1.getSelectedItem().toString());
       try{
            ...
            BufferedWriter fw= new BufferedWriter(new FileWriter(Item,true));
            fw.write(ID+" "+name+" "+supp);
            fw.newLine();
            fw.close();
