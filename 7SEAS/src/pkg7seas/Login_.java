...
public class Login_ extends javax.swing.JPanel {
    ...
    public void init() throws FileNotFoundException
    {
        ...
        this.Cu = new Customers_HomePage(textField1.getText());
        ...
        this.Cl = new Client_HomePage(textField1.getText());
        Cl.addComponentListener(new ComponentListener(){
            @Override
            public void componentHidden(ComponentEvent e) {
                jPanel1.setVisible(true);//To change body of generated methods, choose Tools | Templates.
            }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("WELCOME TO 7SEAS");
