    ...
    private void jComboBox4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox4ActionPerformed
        ...
        try
        {
            ...
            c = DriverManager.getConnection("jdbc:sqlite:LMS.db");
             Statement statement = null;  
            statement = c.createStatement();  
            ResultSet rs = statement.executeQuery("SELECT * FROM BOOKS WHERE Title='"+jComboBox4.getSelectedItem().toString()+"'");
            if(rs.next())
            {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try
        {
            ...
            c = DriverManager.getConnection("jdbc:sqlite:LMS.db");
             Statement statement = null;  
            statement = c.createStatement();  
            statement.executeUpdate("DELETE FROM BOOKS WHERE Title='"+jComboBox4.getSelectedItem().toString()+"'");
            c.close();
