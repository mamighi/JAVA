 ...
 * @author mohammad
 */
public class LeturerHome extends javax.swing.JPanel {

    /**
     * Creates new form LeturerHome
     */
    ViewStudentL VS;
    MarkAttendance MA;
    UpdateAttendanceL UA;
    String loggedUser="";
    public LeturerHome() {
        initComponents();
        ...
        MA= new MarkAttendance();
        MA.addComponentListener(new ComponentListener(){
            @Override
            public void componentHidden(ComponentEvent e) {
                jPanel1.setVisible(true);//To change body of generated methods, choose Tools | Templates.
            }
    ...
    private void initComponents() {
        ...
        jButton9.setText("VIEW STUDENTS LIST");
        ...
        jButton11.setText("MODIFY ATTENDANCE");
